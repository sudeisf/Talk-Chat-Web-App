...
export default function DashBoard(){
      ...
      return (
            <div className="w-full max-w-6xl mx-auto min-h-screen bg-white p-4">
                  ...
                  <SummaryCard percentage="6.6" title="Total Answered" value={97} icon={<CheckCircle size={20} />} color="text-green-600" />
                  <SummaryCard percentage="6.45" title="Pending Threads" value={27} icon={<Clock size={20} />} color="text-yellow-600" />
                  </div>
