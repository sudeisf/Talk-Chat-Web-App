...
export default function AuthLayoutContent ({children,pageType}:AuthLayoutProps){
      ...
      return (
            ...
            pageType === "Login" ? (
                  <div className="flex justify-between p-4">
                        ...
                        <p className="font-sans">Don't have an account?</p><Link href="/register" className="font-sans underline">Sign up</Link>
                  </div>
          </div>
            ) :
