...
import { ArrowBigRight, ArrowRightFromLineIcon, ArrowUpRight, LocateIcon, Mail, MapPin, PhoneCall, PhoneIncoming, PinIcon } from "lucide-react";
import {
  MessageCircle,
  BarChart,
  Bot,
...
export const features = [
  {
    ...
    description: "Talk to real people, in real time. Ask questions and get unstuck instantly.",
  },
  {
    icon: BarChart,
    title: "Personal Learning Dashboard",
    description: "Track what you’ve asked, what you’ve learned, and how you’re improving.",
  },
  {
    icon: Bot,
    title: "AI + Human Collaboration",
    description: "AI helps guide and suggest, but real humans give the best answers.",
  },
  {
    icon: Rocket,
    title: "Instant Matching",
    description: "No waiting. Get paired with a helper right after you submit your question.",
  },
  {
    icon: BookOpen,
    title: "Topic Progress Tracker",
    description: "See how confident you are in topics like React, Python, or Data Structures.",
  },
  {
    icon: Bell,
    title: "Smart Notifications",
    description: "Be alerted when a helper joins your session or replies to your question.",
  },
];
...
export default function Home() {
  ...
  <div className="max-w-6xl mx-auto space-y-8 px-4">
    ...
    <p className="text-lg md:text-xl bg-gradient-to-br from-orange-500 via-red-400 to-orange-300 bg-clip-text text-transparent text-center leading-relaxed">
      ...
      Just ask, get matched instantly, and learn through live chat — one question at a time.
    </p>
  ...
  <div className="flex justify-center mt-12">
    <Button className="bg-red-500 hover:bg-red-600 text-white text-lg py-6 px-10 rounded-lg shadow-lg transition-colors duration-200 flex items-center gap-2">
      Ask a Question & Get Help <ArrowUpRight size={18} />
        ...
        <h1 className="font-pt font-medium text-4xl p-5 ">Why Choose Us & <br/> What You Get</h1>
        ...
        {features.map((feature, idx) => (
          ...
          >
            ...
            <p className="text-gray-600 mt-2 text-md">{feature.description}</p>
          </div>
        ))}
      </div>
      </div>
      ...
      <div className="min-h-screen p-5 w-full">
          <div className="p-4 h-[270px] bg-gradient-to-r from-orange-500 via-red-400 to-orange-400 rounded-md space-y-5">
            <h1 className="text-center uppercase font-medium text-white text-2xl font-pt mt-8">contact us</h1>
            <p className="text-center text-white text-6xl font-pt">We'd love to talk to you</p>
            <div className="flex gap-8 justify-evenly relative top-10 max-w-[80%] mx-auto">
                  <div className="py-10 border space-y-3 bg-white px-8 rounded-md w-1/3 shadow-2xs">
                        ...
                        <h1 className="uppercase font-pt text-gray-500 text-sm font-medium">Call us</h1>
                        <p className="font-sans font-medium text-lg">+25111789089</p>
                        </div>
                  ...
                  <div className="py-10 border space-y-3 bg-white px-8 rounded-md w-1/3 shadow-2xs">
                        ...
                        <div className="flex flex-col align-baseline">
                          <h1 className="uppercase text-gray-500 font-pt text-sm font-medium">Email us</h1>
                          <p  className="font-sans font-medium text-lg">sudeisfed@gmail.com</p>
                        </div>
                  ...
                  <div className="py-10 border space-y-3 px-8 bg-white rounded-md w-1/3 shadow-2xs">
                        ...
                        <div className="flex flex-col align-baseline">
                        <h1 className="uppercase text-sm text-gray-500 font-medium font-pt">Head Quarters</h1>
                        <p  className="font-sans font-medium text-lg">Addis Abeba, Ethiopia</p>
                        </div>
                        </div>
                  </div>
            </div>
          ...
          <div className="flex gap-5 mt-25 p-4 max-w-6xl  mx-auto">
              <div className="w-[40%] flex flex-col justify-center gap-2">
                    <p className="bg-orange-500/5 text-orange-400 shadow-2xs rounded-full py-2 px-4 text-md w-fit font-pt">Our success number</p>
                    <h1 className="text-4xl font-medium">Lets Work Togather</h1>
                    <p className="font-pt text-gray-400 text-lg font-medium">
                      share us improvements , features too add
                      feedback , please contact us for basic questions. we're here to help!
                    </p>
              </div>
              <div className="w-[60%]">
                <form className="space-y-6 p-5">
                   ...
                   <fieldset className="w-full">
                      <Input placeholder="First Name" className="py-5 rounded-sm"/>
                    </fieldset>
                    <fieldset className="w-full">
                      <Input placeholder="Last Name"  className="py-5 rounded-sm" />
                    </fieldset>
                   </div>
                   <fieldset>
                   ...
                   <fieldset className="w-full">
                    <textarea className="w-full border p-2 rounded-sm" rows={8} placeholder="Tell us about your feedback , idea  , improvements..." />
                   </fieldset>
                   <Button className="w-full py-5 rounded-sm bg-gradient-to-r from-orange-500 via-red-400 to-orange-400 text-lg font-sans">Submit</Button>
                </form>
              </div>
          </div>-
      </div>
      ...
      <div className="max-w-6xl mx-auto text-center space-y-4">
        ...
        <p className="text-xs text-black">&copy; {new Date().getFullYear()} Talktit. Built for learners. All rights reserved.</p>
      </div>
    </footer>
    </div>
  );
